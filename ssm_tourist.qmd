...
-   石川県金沢市でのR勉強会
-   第3回を**5月10日**開催（現地+オンライン）— オンラインはまだ空きあります
...
-   [KFAS](https://cran.r-project.org/package=KFAS)を使用
...
-   能登半島地震の影響による来訪者数の減少は1月あたり`r round(-smooth[, "quake"][37], 1)`万人程度と推定
    -   厳密に言うと、2024年1月以降の減少なので、同時期の他の影響もありうる
-   2021年の秋以降、来訪者数は増加傾向にあるが、増加率は最近減少
-   来訪者数は毎年11月にもっとも多く、つづいて5月、3月の順
-   来訪者数が少なくなるのは1月と2月

コードは <https://github.com/ito4303/TokyoR117> にあります。
